import { nested } from '../../js/array/nestedArray.js'
...
const values = [
  ...
  { id: '3', name: 'Usman', parent: '0', children: 'My Father' }
]
...
const results = [
  ...
  { id: '3', name: 'Usman', children: 'My Father' }
]

test('Nesting the flatten array', () => {
  //console.log(nested(values))
  expect(nested(values)).toEqual(results)
})
