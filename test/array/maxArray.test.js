import { max } from '../../js/array/maxArray.js'
...
test('Maximum numbers of all the elements of an array', () => {
  expect(max([8, 4, 7, -9, 5, 6])).toBe(8)
})

test('Maximum numbers of all the elements of an array of objects', () => {
  expect(max(values, 'age')).toBe(58)
})
