...
var toPercentage = function (value, separator) {
    if (separator === void 0) { separator = ':'; }
    var minutePercentage = 100 / 60;
...
var fromPercentage = function (value, separator, display) {
    if (separator === void 0) { separator = ':'; }
    if (display === void 0) { display = 3; }
...
export { double, format, fromPercentage, hoursInBetween, now, reading, relative, toPercentage };
