...
var weekDates = function (current) {
    ...
    for (var j = Number(currentDate.getDay()); j < 6; j++) {
...
export { add, daysInBetween, daysInMonth, daysInYear, daysOfNextMonth, daysOfPrevMonth, doubleFormat, format, isAfter, isBefore, isBetween, month, months, monthsInBetween, now, sub, week, weekDates, weeks, years, yearsInBetween };
